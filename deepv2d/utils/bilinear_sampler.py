...
def gather_nd(image, indicies, batch_dims=0,self=None):
...
def bilinear_sampler(image, coords, batch_dims=1, return_valid=False, self=None):
    ...
    # self.coords00=coords00
    # self.coords01=coords01
    # self.coords10=coords10
    # self.coords11=coords11

    img00 = gather_nd(image, coords00, batch_dims=batch_dims,self=self)
