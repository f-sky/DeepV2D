...
class DeepV2D:
    ...
    def write_ckpt_to_dict(self, sess):
        res = {}
    ...
    def _build_motion_graph(self):
        self.motion_net = MotionNetwork(self.cfg.MOTION, mode=self.mode,
                                        use_regressor=self.use_regressor, is_calibrated=self.is_calibrated,
                                        is_training=False)
    ...
    def __call__(self, images, intrinsics=None, iters=5, viz=False, camposes=None):
        n_frames = len(images)
