...
from deepv2d.trainer import DeepV2DTrainer
...
if __name__ == '__main__':
    ...
    np.random.seed(seed)
    random.seed(seed)
    # --cfg=cfgs/kitti.yaml --name=kitti_model --tfrecords=kitti_train.tfrecords
    parser = argparse.ArgumentParser()
    parser.add_argument('--name', default='kitti_model', help='name of your experiment')
    parser.add_argument('--cfg', default='cfgs/kitti.yaml', help='path to yaml config file')
    parser.add_argument('--tfrecords', default='kitti_train.tf_records',
                        help='path to tfrecords training file')
